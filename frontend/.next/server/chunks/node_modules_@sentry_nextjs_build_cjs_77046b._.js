...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const node = __turbopack_require__("[project]/node_modules/@sentry/node/build/cjs/index.js [instrumentation-edge] (ecmascript)");
/**
 ...
 */ function getWebpackPluginOptions(buildContext, sentryBuildOptions) {
    ...
    const distDir = _nullishCoalesce(_optionalChain([
        userNextConfig,
        'access',
        (_)=>_.distDir,
        'optionalAccess',
    ...
    return {
        ...
        reactComponentAnnotation: {
            ...
            ..._optionalChain([
                sentryBuildOptions,
                'access',
                (_6)=>_6.unstable_sentryWebpackPluginOptions,
                'optionalAccess',
                (_7)=>_7.reactComponentAnnotation
            ])
        },
        ...
        sourcemaps: {
            ...
            assets: _nullishCoalesce(_optionalChain([
                sentryBuildOptions,
                'access',
                (_8)=>_8.sourcemaps,
                'optionalAccess',
            ...
            ignore: _nullishCoalesce(_optionalChain([
                sentryBuildOptions,
                'access',
                (_10)=>_10.sourcemaps,
                'optionalAccess',
                (_11)=>_11.ignore
            ]), ()=>sourcemapUploadIgnore),
            filesToDeleteAfterUpload: _optionalChain([
                sentryBuildOptions,
                'access',
                (_12)=>_12.sourcemaps,
                'optionalAccess',
                (_13)=>_13.deleteSourcemapsAfterUpload
            ]) ? [
            ...
            ..._optionalChain([
                sentryBuildOptions,
                'access',
                (_14)=>_14.unstable_sentryWebpackPluginOptions,
                'optionalAccess',
                (_15)=>_15.sourcemaps
            ])
        },
        release: {
            ...
            ..._optionalChain([
                sentryBuildOptions,
                'access',
                (_30)=>_30.unstable_sentryWebpackPluginOptions,
                'optionalAccess',
                (_31)=>_31.release
            ])
        },
...
"[project]/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const node = __turbopack_require__("[project]/node_modules/@sentry/node/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const chalk = __turbopack_require__("[project]/node_modules/@sentry/nextjs/node_modules/chalk/source/index.js [instrumentation-edge] (ecmascript)");
const resolve = __turbopack_require__("[project]/node_modules/resolve/index.js [instrumentation-edge] (ecmascript)");
const webpackPluginOptions = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/config/webpackPluginOptions.js [instrumentation-edge] (ecmascript)");
/* eslint-disable complexity */ // Next.js runs webpack 3 times, once for the client, the server, and for edge. Because we don't want to print certain
 ...
 */ function constructWebpackConfigFunction(userNextConfig = {}, userSentryOptions = {}) {
    ...
    return function newWebpackFunction(incomingConfig, buildContext) {
        ...
        const staticWrappingLoaderOptions = {
            ...
            nextjsRequestAsyncStorageModulePath: getRequestAsyncStorageModuleLocation(projectDir, _optionalChain([
                rawNewConfig,
                'access',
                (_)=>_.resolve,
                'optionalAccess',
        ...
        if (!isDev) {
            ...
            if (sentryWebpackPlugin) {
                if (!_optionalChain([
                    ...
                    if (!isServer && !_optionalChain([
                        userSentryOptions,
                        'access',
                        (_5)=>_5.sourcemaps,
                        'optionalAccess',
                        (_6)=>_6.deleteSourcemapsAfterUpload
                    ])) {
                        // eslint-disable-next-line no-console
 ...
 */ async function addSentryToClientEntryProperty(currentEntryProperty, buildContext) {
    ...
    const filesToInject = clientSentryConfigFileName ? [
        `./${clientSentryConfigFileName}`
    ] : [];
...
function addValueInjectionLoader(newConfig, userNextConfig, userSentryOptions, buildContext) {
    ...
    const isomorphicValues = {
        ...
        SENTRY_RELEASE: buildContext.dev ? undefined : {
            id: _nullishCoalesce(_optionalChain([
                userSentryOptions,
                'access',
                (_9)=>_9.release,
                'optionalAccess',
                (_10)=>_10.name
            ]), ()=>node.getSentryRelease(buildContext.buildId))
        },
    ...
    const serverValues = {
        ...
        // characters)
        _sentryRewriteFramesDistDir: _optionalChain([
            userNextConfig,
            'access',
            (_11)=>_11.distDir,
            'optionalAccess',
...
exports.getClientSentryConfigFile = getClientSentryConfigFile; //# sourceMappingURL=webpack.js.map
}}),
"[project]/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const fs = __turbopack_require__("[externals]/fs [external] (fs, cjs)");
const resolve = __turbopack_require__("[project]/node_modules/resolve/index.js [instrumentation-edge] (ecmascript)");
const webpack = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/config/webpack.js [instrumentation-edge] (ecmascript)");
/* eslint-disable complexity */ let showedExportModeTunnelWarning = false;
/**
...
function getFinalConfigObject(incomingUserNextConfigObject, userSentryOptions) {
    ...
    if (("TURBOPACK compile-time value", true) && !process.env.SENTRY_SUPPRESS_TURBOPACK_WARNING) {
        // eslint-disable-next-line no-console
        console.warn(`[@sentry/nextjs] WARNING: You are using the Sentry SDK with \`next ${("TURBOPACK compile-time truthy", 1) ? 'dev' : ("TURBOPACK unreachable", undefined)} --turbo\`. The Sentry SDK doesn't yet fully support Turbopack. The SDK will not be loaded in the browser, and serverside instrumentation will be inaccurate or incomplete. ${("TURBOPACK compile-time truthy", 1) ? 'Production builds without `--turbo` will still fully work. ' : ("TURBOPACK unreachable", undefined)}If you are just trying out Sentry or attempting to configure the SDK, we recommend temporarily removing the \`--turbo\` flag while you are developing locally. Follow this issue for progress on Sentry + Turbopack: https://github.com/getsentry/sentry-javascript/issues/8105. (You can suppress this warning by setting SENTRY_SUPPRESS_TURBOPACK_WARNING=1 as environment variable)`);
    }
    return {
        ...incomingUserNextConfigObject,
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const core = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const stackTraceParser = __turbopack_require__("[project]/node_modules/stacktrace-parser/dist/stack-trace-parser.esm.js [instrumentation-edge] (ecmascript)");
 ...
 */ async function devErrorSymbolicationEventProcessor(event, hint) {
    ...
    if (event.type === 'transaction') {
        event.spans = _optionalChain([
            ...
            'call',
            (_9)=>_9((span)=>{
                    const httpUrlAttribute = _optionalChain([
                        span,
                        'access',
                        (_10)=>_10.data,
                        'optionalAccess',
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const constants = __turbopack_require__("[project]/node_modules/next/constants.js [instrumentation-edge] (ecmascript)");
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const core = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const debugBuild = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation-edge] (ecmascript)");
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const core = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const responseEnd = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation-edge] (ecmascript)");
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const core = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)");
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const isBuild = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)");
const wrapperUtils = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/wrapperUtils.js [instrumentation-edge] (ecmascript)");
/**
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
var { _asyncNullishCoalesce } = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
Object.defineProperty(exports, '__esModule', {
    value: true
});
const isBuild = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)");
    ...
    return new Proxy(origGetInitialProps, {
        apply: async (wrappingTarget, thisArg, args)=>{
            ...
            if (req && res) {
                ...
                const { data: initialProps, baggage, sentryTrace } = await _asyncNullishCoalesce(await tracedGetInitialProps.apply(thisArg, args), async ()=>({})); // Next.js allows undefined to be returned from a getInitialPropsFunction.
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
    ...
    if (nextJsOwnedSpan) {
        ...
        if (_optionalChain([
            ...
            _optionalChain([
                ...
                (_3)=>_3.setAttribute,
                'call',
                (_4)=>_4(spanAttributesWithLogicAttached.TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION, true)
            ]);
        }
    }
}
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const core = __turbopack_require__("[project]/node_modules/@sentry/core/build/cjs/index.js [instrumentation-edge] (ecmascript)");
const nextNavigationErrorUtils = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/nextNavigationErrorUtils.js [instrumentation-edge] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)");
const responseEnd = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/responseEnd.js [instrumentation-edge] (ecmascript)");
const tracingUtils = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/tracingUtils.js [instrumentation-edge] (ecmascript)");
/**
...
function wrapServerComponentWithSentry(appDirComponent, context) {
    ...
    return new Proxy(appDirComponent, {
        apply: (originalFunction, thisArg, args)=>{
            const requestTraceId = _optionalChain([
                core.getActiveSpan,
                'call',
                (_)=>_(),
                'optionalAccess',
            ...
            return core.withIsolationScope(isolationScope, ()=>{
                return core.withScope((scope)=>{
                    ...
                    if (activeSpan) {
                        const rootSpan = core.getRootSpan(activeSpan);
                        const sentryTrace = _optionalChain([
                            headersDict,
                            'optionalAccess',
                            (_6)=>_6['sentry-trace']
                        ]);
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
function isReactClassComponent(target) {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
    return typeof target === 'function' && _optionalChain([
        target,
        'optionalAccess',
        (_)=>_.prototype,
        'optionalAccess',
                ...
                return core.withIsolationScope(()=>{
                    ...
                    if (sentryTraceData) {
                        ...
                        scope.setContext('trace', {
                            span_id: _optionalChain([
                                traceparentData,
                                'optionalAccess',
                                (_3)=>_3.parentSpanId
                            ]),
                            trace_id: _optionalChain([
                                traceparentData,
                                'optionalAccess',
                                (_4)=>_4.traceId
                            ])
        ...
        return new Proxy(pageComponent, {
            apply (target, thisArg, argArray) {
                return core.withIsolationScope(()=>{
                    const scope = core.getCurrentScope();
                    // We extract the sentry trace data that is put in the component props by datafetcher wrappers
                    const sentryTraceData = _optionalChain([
                        argArray,
                        'optionalAccess',
                        (_5)=>_5[0],
                        'optionalAccess',
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
        ...
        apply: (originalFunction, thisArg, args)=>{
            ...
            return core.withIsolationScope(isolationScope, ()=>{
                return core.withScope((scope)=>{
                    ...
                    const propagationContext = tracingUtils.commonObjectToPropagationContext(headers, _optionalChain([
                        headersDict,
                        'optionalAccess',
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
async function withServerActionInstrumentationImplementation(serverActionName, options, callback) {
    return core.withIsolationScope(async (isolationScope)=>{
        const sendDefaultPii = _optionalChain([
            core.getClient,
            'call',
            (_)=>_(),
            'optionalAccess',
        ...
        try {
            ...
            sentryTraceHeader = _nullishCoalesce(_optionalChain([
                awaitedHeaders,
                'optionalAccess',
                (_5)=>_5.get,
                'call',
...
"[project]/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
exports.experimental_captureRequestError = experimental_captureRequestError; //# sourceMappingURL=captureRequestError.js.map
}}),
"[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const debugBuild = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/debug-build.js [instrumentation-edge] (ecmascript)");
const devErrorSymbolicationEventProcessor = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/devErrorSymbolicationEventProcessor.js [instrumentation-edge] (ecmascript)");
const getVercelEnv = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/getVercelEnv.js [instrumentation-edge] (ecmascript)");
const spanAttributesWithLogicAttached = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/span-attributes-with-logic-attached.js [instrumentation-edge] (ecmascript)");
const isBuild = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/utils/isBuild.js [instrumentation-edge] (ecmascript)");
const distDirRewriteFramesIntegration = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/server/distDirRewriteFramesIntegration.js [instrumentation-edge] (ecmascript)");
const _error = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation-edge] (ecmascript)");
const wrapGetStaticPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapGetInitialPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapAppGetInitialPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapAppGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapDocumentGetInitialPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapDocumentGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapErrorGetInitialPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapErrorGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapGetServerSidePropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetServerSidePropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapServerComponentWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapServerComponentWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapRouteHandlerWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapRouteHandlerWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapApiHandlerWithSentryVercelCrons = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentryVercelCrons.js [instrumentation-edge] (ecmascript)");
const wrapMiddlewareWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapMiddlewareWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapPageComponentWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapPageComponentWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapGenerationFunctionWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/wrapGenerationFunctionWithSentry.js [instrumentation-edge] (ecmascript)");
const withServerActionInstrumentation = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/withServerActionInstrumentation.js [instrumentation-edge] (ecmascript)");
const captureRequestError = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/captureRequestError.js [instrumentation-edge] (ecmascript)");
const wrapApiHandlerWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation-edge] (ecmascript)");
const globalWithInjectedValues = core.GLOBAL_OBJ;
/**
...
/** Inits the Sentry NextJS SDK on node. */ function init(options) {
    ...
    _optionalChain([
        ...
        (_)=>_.on,
        'call',
        (_2)=>_2('beforeSampling', ({ spanAttributes }, samplingDecision)=>{
        ...
        (_4)=>_4('spanStart', (span)=>{
                ...
                if (typeof _optionalChain([
                    ...
                    (_optionalChain([
                        rootSpanAttributes,
                        'optionalAccess',
                        (_6)=>_6[semanticConventions.ATTR_HTTP_REQUEST_METHOD]
                    ]) || _optionalChain([
                        rootSpanAttributes,
                        'optionalAccess',
                        (_7)=>_7[semanticConventions.SEMATTRS_HTTP_METHOD]
                    ])) && !_optionalChain([
                        rootSpanAttributes,
                        'optionalAccess',
                        (_8)=>_8[semanticConventions.ATTR_HTTP_ROUTE]
                    ])) {
                ...
                ]) === 'BaseServer.handleRequest' && span === core.getRootSpan(span)) {
    ...
    core.getGlobalScope().addEventProcessor(Object.assign((event)=>{
        if (event.type === 'transaction') {
            ...
            if (_optionalChain([
                ...
                (_15)=>_15.match,
                'call',
                (_16)=>_16(/\/__nextjs_original-stack-frame/)
            ])) {
                return null;
            }
            ...
            _optionalChain([
                ...
                (_18)=>_18.match,
                'call',
                (_19)=>_19(/^(GET|HEAD|POST|PUT|DELETE|CONNECT|OPTIONS|TRACE|PATCH) \/(404|_not-found)$/)
            ])) {
                return null;
            }
            ...
            if (_optionalChain([
                ...
                (_22)=>_22.data,
                'optionalAccess',
                (_23)=>_23[spanAttributesWithLogicAttached.TRANSACTION_ATTR_SHOULD_DROP_TRANSACTION]
            ])) {
                return null;
            }
            ...
            if (typeof _optionalChain([
                ...
                (_26)=>_26.data,
                'optionalAccess',
                (_27)=>_27[spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL]
            ]) === 'string') {
    ...
    core.getGlobalScope().addEventProcessor(Object.assign((event, hint)=>{
        ...
        const exceptionMessage = _optionalChain([
            event,
            'access',
            (_29)=>_29.exception,
            'optionalAccess',
        ...
        if (_optionalChain([
            ...
            (_33)=>_33.includes,
            'call',
            (_34)=>_34('Suspense Exception: This is not a real error!')
        ]) || _optionalChain([
            exceptionMessage,
            'optionalAccess',
            (_35)=>_35.includes,
            'call',
            (_36)=>_36('Suspense Exception: This is not a real error, and should not leak')
        ])) {
            return null;
        }
        return event;
        ...
        (_38)=>_38('preprocessEvent', (event)=>{
                ...
                if (event.type === 'transaction' && _optionalChain([
                    ...
                    const target = _optionalChain([
                        ...
                        (_45)=>_45.data,
                        'optionalAccess',
                        (_46)=>_46[semanticConventions.SEMATTRS_HTTP_TARGET]
                    ]);
                ...
                // Next.js 13 is not correctly picking up tracing data for trace propagation so we use a back-fill strategy
                if (event.type === 'transaction' && typeof _optionalChain([
                    event,
                    'access',
                    (_47)=>_47.contexts,
                    'optionalAccess',
                    ...
                    (_49)=>_49.data,
                    'optionalAccess',
                    (_50)=>_50[spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL]
                ]) === 'string') {
                    const traceparentData = core.extractTraceparentData(event.contexts.trace.data[spanAttributesWithLogicAttached.TRANSACTION_ATTR_SENTRY_TRACE_BACKFILL]);
                    if (_optionalChain([
                        traceparentData,
...
"[project]/node_modules/@sentry/nextjs/build/cjs/index.server.js [instrumentation-edge] (ecmascript)": (function(__turbopack_context__) {
...
const withSentryConfig = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/config/withSentryConfig.js [instrumentation-edge] (ecmascript)");
const index = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/server/index.js [instrumentation-edge] (ecmascript)");
const _error = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/_error.js [instrumentation-edge] (ecmascript)");
const wrapApiHandlerWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapApiHandlerWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapGetStaticPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetStaticPropsWithSentry.js [instrumentation-edge] (ecmascript)");
const wrapGetInitialPropsWithSentry = __turbopack_require__("[project]/node_modules/@sentry/nextjs/build/cjs/common/pages-router-instrumentation/wrapGetInitialPropsWithSentry.js [instrumentation-edge] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40sentry_nextjs_build_cjs_77046b._.js.map